...
public final class LayoutLoginBinding implements ViewBinding {
  ...
  private LayoutLoginBinding(@NonNull CardView rootView, @NonNull ProgressBar loading,
      @NonNull Button login, @NonNull EditText password, @NonNull TextInputLayout textInputEmail,
      @NonNull TextInputLayout textInputPassword, @NonNull EditText username) {
  ...
  public static LayoutLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutLoginBinding((CardView) rootView, loading, login, password, textInputEmail,
          textInputPassword, username);
    }
